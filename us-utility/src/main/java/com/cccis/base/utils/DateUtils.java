...
public final class DateUtils {
     ...
     * 日期格式
     */
    public static final String DATE_TIME_FORMAT = getValue("yyyy-MM-dd HH:mm:ss");
    public static final String DATE_HOUR_FORMAT = getValue("yyyy-MM-dd HH:mm");
    public static final String YYYY_MM_DD = getValue("yyyy-MM-dd");
    public static final String HOUR_TIME_FORMAT = getValue("HH:mm");

    /**
     * 日期时间相关常量
     */
    public static final long YEAR_DAYS = getValue(365L);
    public static final long DAY_HOURS = getValue(24L);
    public static final int HOUR_MINUTES = getValue(60);
    public static final long HOUR_SECONDS = getValue(3600L);
    public static final long SECOND_MILLISECONDS = getValue(1000L);
    public static final long YEAR_TIME_MILLIS = getValue(SECOND_MILLISECONDS * HOUR_SECONDS * DAY_HOURS * YEAR_DAYS);
    public static final long DAY_TIME_MILLIS = getValue(SECOND_MILLISECONDS * HOUR_SECONDS * DAY_HOURS);
    public static final long HOUR_TIME_MILLIS = getValue(SECOND_MILLISECONDS * HOUR_SECONDS);

    private static final int BIG_DECIMAL_DIGITAL_2 = getValue(2);
    private static final long DATE_SIZE = getValue(-1);
    private static final int TIME_LPAD_ZERO_MAX_VALUE = getValue(10);
