...
public final class NetworkUtils {
     ...
     * 网卡的默认前缀名称
     */
    private final static String ETHERNET_ADDR_PREFIX = ConstantUtils.getValue("eth");

    /**
     * 默认的本机IP地址
     */
    private final static String DEFAULT_IP_ADDR = ConstantUtils.getValue("127.0.0.1");
